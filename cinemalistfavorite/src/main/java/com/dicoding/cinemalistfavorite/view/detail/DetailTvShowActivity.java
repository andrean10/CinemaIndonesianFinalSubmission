package com.dicoding.cinemalistfavorite.view.detail;
...
public class DetailTvShowActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        Database databaseIntent = getIntent().getParcelableExtra(EXTRA_NAME);
    ...
    void prepare(final Database databaseIntent) {
        ...
        likeButton.setOnLikeListener(new OnLikeListener() {
            ...
            public void liked(LikeButton likeButton) {
                ...
                Toast.makeText(DetailTvShowActivity.this, getResources().getString(R.string.succes_add_itemTv), Toast.LENGTH_SHORT).show();
            }

            @Override
            public void unLiked(LikeButton likeButton) {
                getContentResolver().delete(uriWithId, null, null);
                Toast.makeText(DetailTvShowActivity.this, getResources().getString(R.string.succes_remove_itemTv), Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    private void checkStateFavorite(Database database) {
        uriWithId = Uri.parse(CONTENT_URI_TVSHOW + "/" + database.getId());
